...
class LocaleService extends ValueNotifier<String> {
  ...
  static const _strings = {
    'ru': {
      ...
      // Room
      'permissions_error': 'Нужны разрешения на камеру и микрофон',
      'connection_error': 'Ошибка подключения: ',
      'waiting_participants': 'Ожидание участников...',
      'mic': 'Микрофон',
      'camera': 'Камера',
      'switch_camera': 'Повернуть',
      'speaker': 'Динамик',
      'leave': 'Выйти',
      'you': 'Вы',
      'you_label': 'Вы ({identity})',
    ...
    'en': {
      ...
      // Room
      'permissions_error': 'Camera and microphone permissions are required',
    ...
    'uz': {
      ...
      // Room
      'permissions_error': 'Kamera va mikrofon ruxsati kerak',
      'connection_error': 'Ulanish xatosi: ',
      'waiting_participants': "Ishtirokchilar kutilmoqda...",
      'mic': 'Mikrofon',
      'camera': 'Kamera',
      'switch_camera': "Burish",
      'speaker': 'Dinamik',
      'leave': 'Chiqish',
      'you': 'Siz',
      'you_label': 'Siz ({identity})',
